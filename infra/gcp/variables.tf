...
variable "cidr" {
  ...
  description = "CIDR to use for IP addresses"
  type        = string
}
...
variable "gcp_billing_id" {
  ...
  description = "GCP billing id for doit.tetrate.io"
  type        = string
}

variable "gcp_org_id" {
  default     = "775566979306"
  description = "GCP organization id for tetrate.io"
  type        = string
}
...
variable "jumpbox_machine_type" {
  ...
  description = "Machine type for jumbox"
  type        = string
}

variable "jumpbox_username" {
  default     = "tsbadmin"
  description = "Username for jumbox access"
  type        = string
}
...
variable "preemptible_nodes" {
  default     = false
  description = "Preemptible nodes enablement"
  type        = string
}
