...
resource "google_project" "tsb" {
  ...
  name            = "${var.name_prefix}${random_string.random.result}-${var.cluster_id}-${var.gcp_k8s_region}"
  project_id      = "${var.name_prefix}${random_string.random.result}-${var.cluster_id}-${var.gcp_k8s_region}"
...
module "gcp_base" {
  ...
  name_prefix = "${var.name_prefix}-${var.cluster_id}-${var.gcp_k8s_region}"
