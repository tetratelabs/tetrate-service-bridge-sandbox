...
module "tsb_mp" {
  ...
  tsb_helm_repository_password = coalesce(local.tsb.helm_repository_password, local.tsb.image_sync_apikey)
  tsb_helm_repository_username = coalesce(local.tsb.helm_repository_username, local.tsb.image_sync_username)
