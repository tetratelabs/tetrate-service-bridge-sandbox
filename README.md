...
```mermaid
  graph TD;
      ...
      D[make tsb_cp cluster_id="1" cloud="azure|aws"] --> E[make argocd cluster_id="1" cloud="azure|aws"]
      D[make tsb_cp cluster_id="1" cloud="azure|aws"] --> Z[make app_bookinfo cluster_id="1" cloud="azure|aws"]
