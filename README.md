...
- please refer for the Cloud [Tagging Requirements](https://github.com/tetrateio/tetrate/blob/master/cloud/docs/gcp/labels.md)
  ```s
       "tetrate_owner"    = local.tags_owner
       "tetrate_team"     = local.tags_team
       "tetrate_purpose"  = local.tags_purpose
       "tetrate_lifespan" = local.tags_lifespan
       "tetrate_customer" = local.tags_customer
  ```
## Setup
